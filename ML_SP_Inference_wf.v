...
Proof.
  ...
  revert Eb EB H.
  induction H0; intros.
    inversions H. simpl. split. apply ok_empty. split*.
  simpl in H1.
...
Proof.
  ...
  split.
    apply* disjoint_ok.
    assert (dom e4 << dom e).
      use (incl_subset_dom I4).
    clear -H H0; disjoint_solve.
  assert (incl (e0 & e4) K).
...
Proof.
  ...
  rewrite dom_kinds_open_vars in Hb; auto.
Qed.
...
Proof.
  ...
  assert (HM: scheme M).
    subst M; unfold l0'.
    apply* scheme_generalize. use (split_length _ R4).
  ...
  sets_solve.
    ...
    rewrite fv_in_kind_fv_list in H3.
      ...
      sets_solve.
        ...
        sets_solve.
        rewrite typ_fv_typ_fvars in H1.
        elim (fresh_disjoint _ _ Fr H1). auto.
      use (IHK2 H _ Fr).
...
Proof.
  ...
  split.
    split.
      ...
      unfold M0. simpl.
      split.
        unfold l0'; fold kind. length_hyps.
