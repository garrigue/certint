...
Proof.
  intros; intros HS0 HK0 Dis HTS HS Hext WS Typ Hh.
  ...
  binds_cases Bk1.
    ...
    rewrite Hsub.
      ...
      destruct (S.union_1 H3).
        use (fv_in_spec kind_fv B0 (S.diff_1 H5)).
        auto with sets.
      auto 6 with sets.
    simpl. intros y Hy.
  ...
  case_eq (get Z (combine Xs Us)); intros.
    ...
    use (For_all2_get _ _ _ _ HWk H3 H2).
